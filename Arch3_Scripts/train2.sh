...
#PBS -q low
#PBS -N cnn_reg_bf_adv_1_layer_in_last
...
python3 trainmodel2.py ~/workingDir/models/CNN_regression/ ~/adithya_data_folder/Village_Level_Project_Data/extracted_images_final BF_ADV -1 _pretrain_with_arch_1_1_BF_ADV_layers ~/workingDir/trained_models_arch_1/bf_m_95
