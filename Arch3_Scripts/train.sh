...
#PBS -l select=2:ncpus=2:ngpus=1:mem=64G
...
python3 exp1.py ~/workingDir/models/CNN_regression/ ~/adithya_data_folder/Village_Level_Project_Data/extracted_images_final BF_ADV -3 _pretrain_with_arch_1_3_BF_ADV_layers ~/workingDir/trained_models_arch_1/bf_m_95
